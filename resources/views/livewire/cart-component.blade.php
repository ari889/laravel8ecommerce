        ...
        <div class=" main-content-area">
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        @if(Session::has('coupon'))
                            <p class="summary-info"><span class="title">Discount ({{ Session::get('coupon')['code'] }}) <a href="#" class="text-danger" wire:click.prevent="removeCoupon"><i class="fa fa-times"></i></a></span><b class="index"> - ${{ number_format($discount, 2) }}</b></p>
                            ...
                            <p class="summary-info"><span class="title">Tax ({{ config('cart.tax') }}%)</span><b class="index">${{ number_format($texAfterDiscount, 2) }}</b></p>
                            ...
                            @if($haveCouponCode == 1)
                                <div class="summary-item">
                                    <form wire:submit.prevent="applyCouponCode">
                                        ...
                                        <button type="submit" class="btn btn-small btn-danger">Apply</button>
                                    </form>
                                </div>
                            @endif
                        @endif
            ...
            <div class="wrap-iten-in-cart">
                ...
                @if(Session::has('s_success_message'))
                    <div class="alert alert-success"><strong>Success</strong> {{ Session::get('s_success_message') }}</div>
                @endif
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <p class="text-center">
                                <a href="#" wire:click.prevent="modeToCart('{{ $item->rowId }}')">Move to Cart</a>
                            </p>
                        </div>
                        <div class="delete">
