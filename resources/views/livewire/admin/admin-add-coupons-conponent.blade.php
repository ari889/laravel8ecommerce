                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="POST" class="form-horizontal" wire:submit.prevent="storeCoupon">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Enter coupon code" class="form-control input-md" wire:model="code" />
                                    @error('code')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Enter coupon value" class="form-control input-md" wire:model="value" />
                                    @error('value')
                                        <p class="text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Enter cart value" class="form-control input-md" wire:model="cart_value" />
                                    @error('cart_value')
                                        <p class="text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <input type="text" id="expiry-date" placeholder="Enter expiry date" class="form-control input-md" wire:model="expiry_date" />
                                    @error('expiry_date')
                                        <p class="text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
