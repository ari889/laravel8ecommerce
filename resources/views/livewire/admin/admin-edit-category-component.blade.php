                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="POST" class="form-horizontal" wire:submit.prevent="updateCategory">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Enter category name" class="form-control input-md" wire:model="name" wire:keyup="generateslug" />
                                    @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Enter category slug" class="form-control input-md" wire:model="slug" wire:keyup="" />
                                    @error('slug')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
