                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @foreach($product->orderItems->where('rstatus', 1) as $orderItem)
                            @php
                                $avgrating = $avgrating + $orderItem->review->raring;
                            @endphp
                        @endforeach
                        @for($i=1;$i<=5;$i++)
                            @if($i<=$avgrating)
                                        ...
                                        <ol class="commentlist">
                                            ...
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container">
                                                    ...
                                                    @else
                                                    <img alt="" src="{{ asset('assets/images/profile/default.png') }}" height="80" width="80">
                                                    @endif
                                                    <div class="comment-text">
                                                        <div class="star-rating">
                                                            <span class="width-{{ $orderItem->review->raring * 20 }}-percent">Rated <strong class="rating">{{ $orderItem->review->rating }}</strong> out of 5</span>
                                                        </div>
                                                        <p class="meta">
