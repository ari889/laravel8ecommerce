            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="icon-stat">
                    <div class="row">
                      <div class="col-xs-8 text-left">
                        <span class="icon-stat-label">Today Cancelled</span>
                        <span class="icon-stat-value">{{ $totalCancelled }}</span>
                      </div>
                      <div class="col-xs-4 text-center">
                        <i class="fa fa-times icon-stat-visual bg-danger text-danger"></i>
                      </div>
                    </div>
                    <div class="icon-stat-footer">
                      <i class="fa fa-clock-o"></i> Updated Now
                                  ...
                                  <tbody>
                                      @foreach($orders as $order)
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="{{ route('user.orderdetails', ['order_id' => $order->id]) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                              </td>
                                          </tr>
                                      @endforeach
                                  </tbody>
